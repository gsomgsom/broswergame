<div class="row">
	<div class="col-12">
		<h4>Локации</h4>
		<a href="/player" class="<? if (get_class($this->controller->module) == 'PlayerModule'): ?>active<? endif ?>">Персонаж</a><br>
		...
		<a href="/world/chat" class="<? if (get_class($this->controller->module) == 'ChatModule'): ?>active<? endif ?>">Чат</a><br>
