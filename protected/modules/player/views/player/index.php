...
<div class="row" style="margin-bottom: 16px;">
	...
	<div class="col-md-6">
		<div style="width: 100%; color: #c00;"><img src="/assets/img/str16.png" title="сила"> Сила: <span style="position: absolute; right: 4rem;"><b><?= $this->user->player->countStr() ?> </b></span></div>
		<div style="width: 100%; color: #444;"><img src="/assets/img/def16.png" title="защита"> Защита: <span style="position: absolute; right: 4rem;"><b><?= $this->user->player->countDef() ?> </b></span></div>
		<div style="width: 100%; color: #00c;"><img src="/assets/img/agi16.png" title="ловкость"> Ловкость: <span style="position: absolute; right: 4rem;"><b><?= $this->user->player->countDex() ?> </b></span></div>
		<div style="width: 100%; color: #0c0;"><img src="/assets/img/vit16.png" title="стойкость"> Стойкость: <span style="position: absolute; right: 4rem;"><b><?= $this->user->player->countSta() ?> </b></span></div>
		<div style="width: 100%; color: #404;"><img src="/assets/img/int16.png" title="интеллект"> Интеллект: <span style="position: absolute; right: 4rem;"><b><?= $this->user->player->countInt() ?> </b></span></div>
		<hr>
...
<div class="player-items">
	...
	<? foreach ($this->user->player->player_items as $player_item): ?>
		<? if (!$player_item->equipped): ?>
			<? $used_slots++ ?>
			<? $this->widget('PlayerUnequippedItem', ['player_item' => $player_item]) ?>
		<? endif ?>
	<? endforeach ?>
